...
#users
user1 = User.create(name: 'User1', address: '1234 User St.', city: 'Denver', state: 'CO', zip: '80144', email: 'user@example.com', password: 'password', password_confirmation: 'password')
user2 = User.create(name: 'User2', address: '1234 User St.', city: 'Denver', state: 'CO', zip: '80144', email: 'user2@example.com', password: 'password', password_confirmation: 'password')
user3 = User.create(name: 'User3', address: '1234 User St.', city: 'Denver', state: 'CO', zip: '80144', email: 'user3@example.com', password: 'password', password_confirmation: 'password')

merchant = User.create(name: 'Merchant Megan', address: '411 Merchant St.', city: 'Denver', state: 'CO', zip: '80144', role: 1, email: 'merchant@example.com', password: 'password', password_confirmation: 'password')
megan_shop.users << merchant

merchant_brian = User.create(name: 'Merchant Brian', address: '114 Merchant St.', city: 'Denver', state: 'CO', zip: '80134', role: 1, email: 'merchant_brian@example.com', password: 'password', password_confirmation: 'password')
brian_shop.users << merchant_brian

admin = User.create(name: 'Benny', address: '101 Admin St.', city: 'Denver', state: 'CO', zip: '80144', role: 2, email: 'admin@example.com', password: 'password', password_confirmation: 'password')
